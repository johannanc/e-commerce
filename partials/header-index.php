<header>
  ...
  <div class="header_container">
    ...
    <div class="header_logo">
        <a href="index.php"><img src="img/logo.png" alt="imagen del logo"></a>
    </div>
    ...
    <div class="header_nav">
      <ul>
        ...
        <li><a href="secciones/proximamente.php">Ofertas </a></li>
        <li><a href="secciones/proximamente.php">Locales </li>
        <li><a href="secciones/proximamente.php">Nosotros </li>
        <li><a href="secciones/proximamente.php">Contacto </li>
      </ul>
    </div>
    <!-- FIN contenedor del menu -->
    <!-- INICIO contenedor de la barra de busqueda -->
    <div class="header_busqueda">
      <form class="header_busquedaForm" action="index.php" method="post">
    ...
    <div class="header_iconos">
      <ul class="header_ul">
        ...
        <li><a href="secciones/proximamente.php"><i class="fas fa-cart-arrow-down fa-2x"></i></a></li>
      </ul>
    </div>
